...
function soal(){
    ...
    soalTPA [30] = 'Pada tahun 2018, Indonesia berduka dengan adanya bencana yang menimpa Kabupaten Donggala dan Palu. Bantuan demi bantuan diberikan oleh relawan kepada korban bencana, baik itu berupa makanan, minuman, pakaian, dan bantuan lainnya. Tindakan relawan tersebut termasuk pengamalan Pancasila sila ke ….'//p-2_4
    soalTPA [31] = 'Agenda pokok sidang BPUPKI yang berlangsung dari tanggal 10–16 Juli 1945 membahas tentang ....'//P-2_5
    soalTPA [32] = 'Lembaga negara yang berhak mengangkat hakim agung serta menegakkan kehormatan perilaku hakim adalah ....'//P-2_10
    soalTPA [33] = 'Indonesia terdiri atas beraneka ragam suku bangsa yang memiliki kebudayaan dan adat istiadat yang bermacammacam. Hal ini menyebabkan ….'//P-2_15
    soalTPA [34] = 'Semboyan <i>Bhinneka Tunggal Ika</i> tercantum dalam Undang-Undang Dasar 1945 pada pasal 36A. Isi pada pasal tersebut selain menyebutkan semboyan negara tetapi juga menyebutkan ….'//p-2_16
    // ================================ soal TIU ================================
    soalTPA [35] = 'Sinonim dari kata dimensi adalah ….'
    soalTPA [36] = 'Persamaan dari kata cengkar adalah ….'
    soalTPA [37] = 'Antonim dari kata absurd adalah ….'
    soalTPA [38] = 'Lawan dari kata vokal adalah ….'
    soalTPA [39] = 'STETOSKOP : DOKTER = NOZEL : ….'
    soalTPA [40] = 'MENLU : RETNO MARSUDI = ….'
    soalTPA [41] = 'Nilai dari ${3/4} + {3/2} + {9/4} + ... + 24$ adalah ...'
    // soalTPA [37] = '$75 × 18 + 43 - 81 × 7 =$ ...' // TOCPNS2 no. 7
    soalTPA [42] = '$3,33...$ dari $11{1/4}$ sama dengan $5/6$ dari ...'
    soalTPA [43] = 'Jika $a$ adalah bilangan bulat positif terkecil yang habis dibagi 10, 15, dan 25, maka nilai dari ${1/3}a - 10$ adalah ...'
    soalTPA [44] = 'Bilangan yang dapat habis dibagi 3 dan 44 adalah ….'
    soalTPA [45] = 'Diketahui bahwa 𝑥 dan 𝑦 adalah bilangan asli dengan 𝑥 > 𝑦. $x^2 - 9x + 14 = 0$ dan ${x^4}y + 2y = 18$, maka nilai $xy$ adalah ...'
    soalTPA [46] = 'Jika −2 < 𝑟 < 6 dan −1 < 𝑠 < 7, maka ….'
    soalTPA [47] = 'Jika 1,23456 … = $x/y$ dengan 𝑥 dan 𝑦 bilangan positif, maka ….'
    soalTPA [48] = 'Jika $b = √a − 2$ dengan 𝑎 dan 𝑏 anggota bilangan asli, maka ….'
    soalTPA [49] = 'Jika $16{x^2} - 49{y^2} = 72$ dan $4x + 7y  = 18$, maka ....'
    soalTPA [50] = 'Jika 𝑒 adalah 1,87% dari 2345 dan 𝑓 adalah 23,45% dari 1870, maka ….'
    soalTPA [51] = 'Sebuah kelas akan memilih seorang murid diantara mereka untuk menjadi ketua kelas. Setiap murid mempunyai kesempatan yang sama untuk dipilih. Peluang murid perempuan terpilih sama dengan $3/5$kali peluang terpilihnya murid laki-laki. Persentase murid laki-laki di kelas tersebut adalah ….'
    soalTPA [52] = 'Kubus dengan panjang rusuk 𝑎 cm diperkecil sehingga panjang rusuknya menjadi seperlima panjang rusuk semula. Jika setelah diperkecil panjang diagonal ruangnya menjadi $b√3$ cm, maka panjang 𝑎 adalah …. cm.'
    soalTPA [53] = 'Pak Sutejo mendapat upah Rp1.710.000,00 setelah bekerja selama 18 hari dengan 6 hari diantaranya lembur. Berapa upah yang didapat pak Sutejo jika ia bekerja selama 12 hari dengan 4 hari diantaranya lembur?'
    soalTPA [54] = 'Seorang pengusaha berencana untuk menghasilkan keuntungan setelah pajak pada tahun 2019 sebesar 40% dari penjualan. Jika besarnya pajak adalah 10% dari keuntungan sebelum pajak dan semua biaya sebesar Rp500 juta, berapa minimal penjualan yang harus dicapai untuk memperoleh keuntungan seperti yang direncanakan?'
    soalTPA [55] = 'Setiap diantara dua suku yang berurutan pada barisan 3, 23, dan 43 disisipkan tiga bilangan sehingga terbentuk barisan aritmatika yang baru. Jumlah enam suku pertama barisan yang terbentuk adalah ….'
    soalTPA [56] = 'B, D, F, J, P, ….'
    // soalTPA [53] = '-6, 1, - 1, 6, 4, 11, 9, …, ….'
    // soalTPA [54] = '90, 72, 56, 42, 30, 20, ..., ...' //TOCPNS2 no 22
    soalTPA [57] = '2; $3/2$; $1{1/3}$; $5/4$; 1,2; $1{1/6}$; $8/7$; ...' //TOCPNS2 no 23
    soalTPA [58] = 'Semua seniman dapat melukis dengan baik. Sebagian besar lulusan Universitas Berkarya adalah seniman. Santoso dapat melukis dengan baik, Santoso adalah lulusan Universitas Berkarya.'
    soalTPA [59] = 'Singa makan daging rusa. Daging rusa sangat bergizi. Semua yang makan makanan bergizi badannya menjadi sehat.'
    soalTPA [60] = 'Ratna akan berenang jika dan hanya jika Santi berenang. Santi akan berenang jika dan hanya jika Titin berenang. Ternyata Santi berenang.'
    soalTPA [61] = '<b>Perhatikan ilustrasi berikut!</b><br> Delapan siswa yaitu Asni, Bagus, Candra, Deni, Epa, Fitri, Galih, dan Hasim akan dibagi menjadi 2 kelompok belajar oleh gurunya. Masing-masing kelompok belajar terdiri dari 4 orang siswa. Adapun ketentuan dari pembentukan kelompok tersebut yaitu Asni harus satu kelompok dengan Deni, Bagus harus berbeda kelompok dengan Galih, jika Candra masuk dikelompok 1 maka Fitri harus dikelompok 1 juga, dan jika Hasim masuk dikelompok 2 maka Bagus harus dikelompok 1.<br><br>Jika Bagus masuk kelompok 1, maka siswa yang pasti masuk dikelompok 2 adalah ….'
    soalTPA [62] = '<b>Perhatikan ilustrasi berikut!</b><br> Ananda memiliki enam boneka dengan warna berbeda yang ia susun berdampingan dengan nomor urut 1 s.d 6 dengan ketentuan: boneka biru bersebelahan dengan boneka putih, boneka hitam sebelum boneka coklat dan diletakan pada urutan keempat setelah boneka merah, dan boneka kedua setelah boneka kuning adalah boneka putih.<br><br>Boneka pada urutan ketiga adalah ….'
    soalTPA [63] = '<img src="../../assets/img/SKD_p-3/62/soal.png" style="width: auto;"/>'
    soalTPA [64] = '<img src="../../assets/img/SKD_p-3/63/soal.png" style="width: auto;"/>'
    ...
    opsi [31][0] = 'A. Pendirian PPKI'
    opsi [31][1] = 'B. Rancangan UUD dan pembukaannya'
    opsi [31][2] = 'C. Pembacaan teks proklamasi'
    opsi [31][3] = 'D. Dasar negara Indonesia merdeka'
    opsi [31][4] = 'E. Waktu dan tempat dibacakannya proklamasi'
    opsi [31][5] = '2'

    opsi [32][0] = 'A. Komisi Yudisial'
    opsi [32][1] = 'B. Mahkamah agung'
    opsi [32][2] = 'C. Jaksa agung'
    opsi [32][3] = 'D. DPR'
    opsi [32][4] = 'E. Presiden'
    opsi [32][5] = '1'

    opsi [33][0] = 'A. Kebudayaan tidak dapat dipadukan karena memiliki nilai budayanya sendiri'
    opsi [33][1] = 'B. Indonesia sulit bersatu karena pemikiran tiap suku bangsa yang berbeda-beda'
    opsi [33][2] = 'C. Menguatnya paham primordialisme'
    opsi [33][3] = 'D. Memperkaya sifat dan makna persatuan bangsa dan negara Indonesia'
    opsi [33][4] = 'E. Setiap nilai-nilai kebudayaan saling bertentangan satu dengan yang lainnya'
    opsi [33][5] = '4'

    opsi [34][0] = 'A. Bendera negara'
    opsi [34][1] = 'B. Bahasa negara'
    opsi [34][2] = 'C. Lambang negara'
    opsi [34][3] = 'D. Lagu Kebangsaan'
    opsi [34][4] = 'E. Bentuk negara'
    opsi [34][5] = '3'
    ...
    opsi [37][0] = 'A. Jelas'
    opsi [37][1] = 'B. Beraturan'
    opsi [37][2] = 'C. Bersih'
    opsi [37][3] = 'D. Terang'
    opsi [37][4] = 'E. Rasional'
    opsi [37][5] = '5'
    ...
    opsi [39][0] = 'A. Analis'
    opsi [39][1] = 'B. Apoteker'
    opsi [39][2] = 'C. Polisi'
    opsi [39][3] = 'D. Pemadam kebakaran'
    opsi [39][4] = 'E. Optalmolog'
    opsi [39][5] = '4'

    opsi [40][0] = 'A. Menhan : Mahfud M.D.'
    opsi [40][1] = 'B. Menkopolhukam : Prabowo'
    opsi [40][2] = 'C. Menkeu : Sri Mulyani'
    opsi [40][3] = 'D. Menpora : Nadiem'
    opsi [40][4] = 'E. Mensos : Budi Karya'
    opsi [40][5] = '3'
    ...
    opsi [47][2] = 'C. 𝑥 = 𝑦'
    opsi [47][3] = 'D. 𝑥 ≤ 𝑦'
    opsi [47][4] = 'E. Hubungan 𝑥 dan 𝑦 tidak dapat ditentukan'
    opsi [47][5] = '1'
    ...
    opsi [48][2] = 'C. 𝑎 = 𝑏'
    opsi [48][3] = 'D. 𝑎 = 2𝑏'
    opsi [48][4] = 'E. Hubungan 𝑎 dan 𝑏 tidak dapat ditentukan'
    opsi [48][5] = '2'

    opsi [49][0] = 'A. 𝑥 < 𝑦'
    opsi [49][1] = 'B. 𝑥 = 3𝑦'
    opsi [49][2] = 'C. 𝑥 = 𝑦'
    opsi [49][3] = 'D. 𝑥 = 𝑦 + 1,75'
    opsi [49][4] = 'E. Hubungan 𝑥 dan 𝑦 tidak dapat ditentukan'
    opsi [49][5] = '4'
    ...
    opsi [50][2] = 'C. 𝑒 > 𝑓'
    opsi [50][3] = 'D. 𝑒 = 100𝑓'
    opsi [50][4] = 'E. Hubungan 𝑒 dan 𝑓 tidak dapat ditentukan'
    opsi [50][5] = '1'
    ...
    opsi [53][0] = 'A. Rp1.420.000,00'
    opsi [53][1] = 'B. Rp1.230.000,00'
    opsi [53][2] = 'C. Rp1.140.000,00'
    opsi [53][3] = 'D. Rp1.050.000,00'
    opsi [53][4] = 'E. Rp960.000,00'
    opsi [53][5] = '3'

    opsi [54][0] = 'A. Rp. 1 milyar'
    opsi [54][1] = 'B. Rp. 950 juta'
    opsi [54][2] = 'C. Rp. 900 juta'
    opsi [54][3] = 'D. Rp. 850 juta'
    opsi [54][4] = 'E. Rp. 800 juta'
    opsi [54][5] = '3'
    ...
    opsi [58][0] = 'A. Santoso adalah seniman'
    opsi [58][1] = 'B. Santoso bukan seniman'
    opsi [58][2] = 'C. Santoso bukan seniman yang dapat melukis dengan baik'
    opsi [58][3] = 'D. Santoso salah satu seniman lulusan Universitas Berkary'
    opsi [58][4] = 'E. Tidak dapat disimpulkan'
    opsi [58][5] = '5'

    opsi [59][0] = 'A. Badan singa menjadi sehat'
    opsi [59][1] = 'B. Singa lebih sehat daripada rusa'
    opsi [59][2] = 'C. Badan singa menjadi kuat'
    opsi [59][3] = 'D. Singa tidak sehat'
    opsi [59][4] = 'E. Tidak dapat disimpulkan'
    opsi [59][5] = '1'

    opsi [60][0] = 'A. Ratna dan Titin tidak berenang'
    opsi [60][1] = 'B. Ratna dan Titin berenang'
    opsi [60][2] = 'C. Titin berenang dan Ratna belum tentu berenang'
    opsi [60][3] = 'D. Ratna berenang dan Titin belum tentu berenang'
    opsi [60][4] = 'E. Tidak dapat disimpulkan'
    opsi [60][5] = '2'
    ...
    opsi [63][0] = '<img src="../../assets/img/SKD_p-3/62/A.png"/>'
    opsi [63][1] = '<img src="../../assets/img/SKD_p-3/62/B.png"/>'
    opsi [63][2] = '<img src="../../assets/img/SKD_p-3/62/C.png"/>'
    opsi [63][3] = '<img src="../../assets/img/SKD_p-3/62/D.png"/>'
    opsi [63][4] = '<img src="../../assets/img/SKD_p-3/62/E.png"/>'
    opsi [63][5] = '4'

    opsi [64][0] = '<img src="../../assets/img/SKD_p-3/63/A.png"/>'
    opsi [64][1] = '<img src="../../assets/img/SKD_p-3/63/B.png"/>'
    opsi [64][2] = '<img src="../../assets/img/SKD_p-3/63/C.png"/>'
    opsi [64][3] = '<img src="../../assets/img/SKD_p-3/63/D.png"/>'
    opsi [64][4] = '<img src="../../assets/img/SKD_p-3/63/E.png"/>'
    opsi [64][5] = '3'
